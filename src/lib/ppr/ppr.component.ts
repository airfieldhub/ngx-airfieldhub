...
export class PprComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.iframeTag = `
      <iframe src="https://airfieldhub.com/widget.html/arrival/`+this.airfieldhub_key+`/" frameborder="0" scrolling="no" allowtransparency="true"></iframe>
      `;
  }
